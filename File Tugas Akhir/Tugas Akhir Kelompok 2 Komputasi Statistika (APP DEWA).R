                                ...
                                fluidRow(
                                  box(
                                    ...
                                    HTML("
                                              ...
                                              <p>Aplikasi ini dirancang untuk melakukan analisis dan peramalan pada data deret waktu. Anda dapat mengunggah data Anda sendiri, mengurutkannya berdasarkan tanggal, menganalisisnya, dan membandingkan kinerja berbagai model.</p>
                                              ...
                                              <ol>
                                                ...
                                                <li>Hasil akan disajikan dalam bentuk <strong>Plot</strong>, tabel <strong>Detail Model</strong>, dan tabel detail <strong>Perbandingan Data</strong> serta <strong>Hasil Ramalan</strong> yang menyertakan tanggal.</li>
                                              </ol>"
                                    )
                                  )
                                )
                    ...
                    dashboardBody(
                      ...
                      tabItems(
                        ...
                        tabItem(tabName = "Theorem",
                                fluidRow(
                                  box(
                                    title = "Landasan Teori Peramalan Deret Waktu", width = 12, solidHeader = TRUE, status = "primary",
                                    HTML("
                                              <h3 style='text-align:center; font-weight:bold;'>Peramalan Data Deret Waktu</h3>
                                              <p><strong>Data deret waktu (time series)</strong> adalah sekumpulan observasi yang diurutkan berdasarkan waktu. Analisisnya fokus pada identifikasi pola seperti <em>tren</em> dan <em>musiman</em> untuk membuat peramalan.</p>
                                              <hr>
                                              <h4 style='text-align:center; font-weight:bold;'>Dekomposisi Deret Waktu</h4>
                                              <p>Dekomposisi adalah proses memecah data menjadi komponen penyusunnya: <strong>Tren (Trend, T_t)</strong>, <strong>Musiman (Seasonal, S_t)</strong>, dan <strong>Acak (Random/Residual, E_t)</strong>. Ini membantu memahami struktur data.</p>
                                              <hr>
                                              <h4 style='text-align:center; font-weight:bold;'>Metode-Metode Peramalan</h4>
                                              <h5><strong>1. Single Moving Average (SMA)</strong></h5><p>Cocok untuk data stasioner tanpa tren atau musiman.</p>
                                              <h5><strong>2. Double Moving Average (DMA)</strong></h5><p>Baik untuk data dengan pola tren linier.</p>
                                              <h5><strong>3. Simple Exponential Smoothing (SES)</strong></h5><p>Memberi bobot lebih pada data baru, ideal untuk data tanpa tren/musiman.</p>
                                              <h5><strong>4. Holt's Exponential Smoothing</strong></h5><p>Dirancang untuk data dengan pola tren.</p>
                                              <h5><strong>5. Holt-Winters' Exponential Smoothing</strong></h5><p>Metode komprehensif untuk data dengan tren dan musiman.</p>
                                              <hr>
                                              <h4 style='text-align:center; font-weight:bold;'>Ukuran Evaluasi Model</h4>
                                              <p>Metrik seperti <strong>MSE</strong>, <strong>RMSE</strong>, dan <strong>MAPE</strong> digunakan untuk mengukur seberapa dekat nilai peramalan (\\(\\hat{y}_t\\)) dengan nilai aktual (\\(y_t\\)).</p>"
                                    )
                                  )
                                )
                        ),
